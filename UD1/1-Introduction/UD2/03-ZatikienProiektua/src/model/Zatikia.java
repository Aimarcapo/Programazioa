...
public class Zatikia {
    ...
    public Zatikia(String zatIdatzia) {
       ...
       String goi=zatIdatzia.substring(0, barra);
       String behe=zatIdatzia.substring(barra+1, strLen);
       int zenbakitzailea=Integer.parseInt(goi);
       int izendatzailea=Integer.parseInt(behe);
    ...
    public static Zatikia biderkatu(Zatikia zat1, Zatikia zat2) {
        Zatikia emaitza = new Zatikia((zat1.getZenbakitzailea() * zat2.getZenbakitzailea()),
    ...
    public static Zatikia batu(Zatikia zat1, Zatikia zat2) {
        Zatikia emaitza = new Zatikia(
                ((zat1.getZenbakitzailea() * zat2.getIzendatzailea())
    ...
    /**
     * Metodo honek, esaten du, erabiltzen ari den zatikia, bestearekiko baliokidea
     * den ala ez
     */
