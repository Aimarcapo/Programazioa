...
public class ProgramaNagusiaArrayList {
    ...
    public static void main(String[] args) {
        ...
        liburuakArrayList = Liburua.getLiburuenArrayLista();
        ...
        do {
            do {
                try {
                    ...
                    System.out.println(
                            "Zenbaki bat sartu behar duzu aukeratutako aukera ejekutatzeko, saiatu berriz mesedez");
                    sc.next();
            ...
            /**
             * Mientras no haya salbuespena es decir que sea false seguira repitiendo el
             * proceso hasta que haya salbuespena que en este caso es cuando pongas un
             * numero que no de excepciones
             */
        ...
        } while (aukera != 5);/** Mientras que aukera sea distinto a 5 */
    }
    ...
    public static void liburuenDatuGuztiakIkusi() {
        ...
        for (int i = 0; i < liburuakArrayList.size(); i++) {
            ...
            System.out.printf("%-3d %-30s %-20s %4d %4d %-11s %1s %-6.2f %-15s\n", i + 1,
                    liburuakArrayList.get(i).getIzenburua(), liburuakArrayList.get(i).getEgilea(),
                    liburuakArrayList.get(i).getOrriKopurua(), liburuakArrayList.get(i).getUrtea(),
                    liburuakArrayList.get(i).getGaia(), liburuakArrayList.get(i).getHizkuntza(),
                    liburuakArrayList.get(i).getPrezioa(), liburuakArrayList.get(i).getKodea());
    ...
    public static void liburuenPrezioaIrudikatu() {
        ...
        for (int i = 0; i < liburuakArrayList.size(); i++) {
            ...
            System.out.printf("%30s: %2s\n", liburuakArrayList.get(i).getIzenburua(),
                    liburuakArrayList.get(i).getPrezioaIzartxotan());
    ...
    public static void zaharrenaBilatu() {
        ...
        System.out
                .println("Liburu zaharrena " + zaharrena + " urtean argitaratu zen: " + liburuakArrayList.get(liburua));
    }
    ...
    public static void liburuaGehitu() {
        ...
        liburuakArrayList.add(new Liburua(izenburuBerria, egileBerria, orriKopuruBerria, urteBerria, gaiBerria,
                hizkuntzaBerria, prezioBerria));
    }
