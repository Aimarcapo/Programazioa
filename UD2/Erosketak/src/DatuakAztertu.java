...
public static void erosketaKopuruaUrteEtaHilabeteko(){
    ...
    System.out.println("\nEPEKAKO EROSKETEN TXOSTENA");
            ...
            System.out.println(
                    "-----------------------------------------------------------------------------------------------------------------------------------------\n");
        for (int i = 0; i < erosketenZerrenda.size(); i++) {
            eguna=erosketenZerrenda.get(i).getData().getDayOfYear();
            urtea=erosketenZerrenda.get(i).getData().getYear();
            hilabetea=erosketenZerrenda.get(i).getData().getMonth();
        System.out.println(erosketenZerrenda.get(i).getData().getDayOfYear()); 
    }
}
}
