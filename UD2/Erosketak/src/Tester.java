...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        Bezeroa uni = new Enpresa(3, "IES Uni BHI","Uni Eibar-Ermua","Otaola Hiribidea 29, Eibar",emailak);
        ...
        laugarrenErosketaUnitateak.add(1);
        Erosketa laugarrenErosketa = new Erosketa("E19-02", "2019-02-09", karlos,
                laugarrenErosketaProduktuak, laugarrenErosketaUnitateak, 3250);
