...
public class Controller {
    ...
    public static void leer() {
        for (int i = 0; i < listaProductos.size(); i++) {
            if(listaProductos.get(i) instanceof Congelados){
                System.out.println((Congelados)listaProductos.get(i));
            }
            else if(listaProductos.get(i) instanceof Refrigerados){
                System.out.println((Refrigerados)listaProductos.get(i));
            }
            else if(listaProductos.get(i) instanceof Frescos){
                System.out.println((Frescos)listaProductos.get(i));
            }
        }
    }
}