...
Estos productos son bebidas como agua mineral y bebidas azucaradas (coca-cola, fanta, etc). De los productos nos interesa saber su identificador (cada uno tiene uno distinto), 
...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        AguaMineral AGUA = new AguaMineral(13, 2, 34, "Bezoya", "Murcia");
        BebidaAzucarada coca = new BebidaAzucarada(7, 1, 2, "Cocacola", 37, true);
        BebidaAzucarada aquarius = new BebidaAzucarada(4, 68, 3, "Fanta", 0, false);
        AguaMineral aqua = new AguaMineral(9, 35, 47, "Pever", "Badajoz");
       
        Almacen almacen = new Almacen(5, 5);

        almacen.agregarBebida(aqua);
        almacen.agregarBebida(AGUA);
        almacen.agregarBebida(coca);
        almacen.agregarBebida(aquarius);
